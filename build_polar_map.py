...
<body>
  <div id="toolbar">
    ...
    <span id="hint">Wheel zoom · drag background to pan · drag nodes · narrow filters in panel →</span>
  </div>
  ...
  (function () {
    ...
    function legendTextBox(gParent, x, y, label, strokeColor) {
      const padX = 7;
      const padY = 4;
    ...
    ringLabels.forEach((ring) => {
      ...
      legendTextBox(legendG, lx, ly, ring.t, null);
    });
